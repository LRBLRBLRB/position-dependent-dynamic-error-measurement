...
该模块包含较完整的处理链，包括小波去噪、降采样、几何定位误差补偿、速度/加速度计算、位移峰谷分段、速度段提取和动态指标整理。运行前请根据实验修改文件路径、测点方向/符号设置、几何误差文件路径和分段阈值。完整说明见 [`src/2-data-analysis/ids-3010/README.md`](src/2-data-analysis/ids-3010/README.md)。
